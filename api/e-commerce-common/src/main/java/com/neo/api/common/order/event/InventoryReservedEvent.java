...
public record InventoryReservedEvent(UUID accountId, InventoryEventName eventName, String orderId,
                                     double totalAmount, Instant createdDate) implements Serializable {
