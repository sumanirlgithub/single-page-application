...
import com.neo.api.order.model.PaymentAuthResult;
...
public class PaymentClient {
    ...
    public Mono<PaymentAuthResult> authorize(OrderRequestPayload request) {
        return webClient.post()
                .uri("https://localhost:8084/api/v1/payment/authorize")
                .bodyValue(request)
                .retrieve()
                .bodyToMono(PaymentAuthResult.class);
    }
